		...
		<div class="main single">
			<div class="max_width">
				<div class="action_buts">
					...
					<? if ($object->id):?>
						<a class="button confirm pointer" data-confirm= "Remove the construction?" data-action="/admin/orders/remove/<?=$object->id?>/"
					...
					<? endif;?>
					<a href="/admin/orders/categories/"><img src="/admin/images/buttons/back.png" alt="" /> Вернуться</a>
				</div>
				<p class="speedbar"><a href="/admin/">Главная</a>     <span>></span>
					<a href="/admin/orders/">Заказы</a>    <span>></span>
					<a href="/admin/orders/categories/">Категории</a>    <span>></span>
					<?= $object->id ? $object->name: 'Добавление'?>
				</p>
				<div class="clear"></div>
				<form class="form<?=($object->id)?'Edit':'AddCategory'?>" action="/admin/orders/category<?=($object->id)?'Edit':'Add'?>/" method="post" data-post-action="/admin/orders/categories/">
					<div id="tabs">
						<div class="tab_page">
							<ul>
