	...
	<table style="font-size: 12px;">
		<tr>
			<td>
				...
				<a href="<?=DIR_HTTP?>admin/orders/order/<?=$order->id?>/" style="padding: 5px 10px; border: 1px solid #00a336; background: #17a845; color: #ffffff; text-decoration: none; font-size: 13px; width: 300px; display: block; text-align: center;">Посмотреть заказ</a>
