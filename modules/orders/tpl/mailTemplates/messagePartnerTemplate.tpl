<?include(DIR.'/modules/orders/tpl/mailTemplates/messagePartnerBase.tpl')?>

<br /><br />
<u>Текст сообщения:</u>
<br /><br />
<textarea class="aditionalMessage" style="width: 500px; height: 80px;"></textarea>
			...
			<ul>
				<li>
					...
					<ul>
						...
						<li>
							<label class="manager">
								<input type="checkbox" class="managers" value="<?=$manager->getLogin()?>"> <?=$manager->name?> (<?=$manager->getLogin()?>)
							</label>
						</li>
						<?endforeach; endif?>
					</ul>
