...
class OrderProcessingComplectsGoodConfig extends \core\modules\base\ModuleConfig
{
	...
	protected $objectClass  = '\modules\orderProcessing\orderProcessingComplectsGoods\lib\OrderProcessingComplectsGood';
	protected $objectsClass = '\modules\orderProcessing\orderProcessingComplectsGoods\lib\OrderProcessingComplectsGoods';

	public $templates  = 'modules/orderProcessing/tpl/';

	protected $table = 'order_processing_complects_goods'; // set value without preffix!
