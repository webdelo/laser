...
class MessageService extends \core\modules\base\ModuleObject implements \interfaces\IConsole, IMessage
{
	use \core\traits\controllers\Authorization,
		\core\traits\ObjectPool,
		\core\i18n\translator\SerializeTranslatorTrait,
	...
	{
		return $this->getTranslator()->getFromSerialize($this->text);
	}
