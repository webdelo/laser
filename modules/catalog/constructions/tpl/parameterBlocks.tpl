<script type="text/javascript" src="/modules/catalog/constructions/js/parametersAdding.js"></script>
<link rel="stylesheet" type="text/css" href="/modules/catalog/constructions/css/parameters.css" />
<div id="partsSortable" data-action="/admin/parameters/changePriority/">
	...
	<div class="parametersParts addingMode notSortable">
		<input
			...
			data-post="&additionalCategories[]=<?=$object->getCategory()->id?>"
		/>
	</div>
