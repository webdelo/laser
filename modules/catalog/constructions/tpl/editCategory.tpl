		...
		<div class="col_in">
			<table width="100%">
				...
				<tr>
					...
					<td><textarea name="delivery" cols="95" rows="10"><?=$object->delivery?></textarea>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<select name="template">
							...
							<option <?=($object->template=='catalogTwoInLineContent')?'selected':''?> value="catalogTwoInLineContent" >Две колонки товаров</option>
							<option <?=($object->template=='catalogVerticalListContent')?'selected':''?> value="catalogVerticalListContent">Одна колонка товаров</option>
							<option <?=($object->template=='catalogSpecialTeplitsyTemplate')?'selected':''?> value="catalogSpecialTeplitsyTemplate">Специальный шаблон Теплиц</option>
						</select>
					</td>
				</tr>
			</table>
