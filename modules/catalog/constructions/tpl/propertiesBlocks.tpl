<script type="text/javascript" src="/modules/catalog/constructions/js/propertiesAdding.js"></script>
<link rel="stylesheet" type="text/css" href="/modules/catalog/constructions/css/properties.css" />
<div id="partsPropertiesSortable" data-action="/admin/properties/changePriority/">
	...
	<div class="propertiesParts" data-id="<?=$property->id?>">
		...
		<div class="propertiesSortable" data-action="/admin/<?=$_REQUEST['controller']?>/changePropertiesValuesPriority/">
				...
				<div class="property" data-id="<?=$value->id?>">
					<div class="propertyDetails viewMode">
						<div class="propertyValue">
							...
							<div class="assigned">
								<? if ( $object->getPropertyValueById($value->id)->value ): ?>
								...
								<? else: ?>
									<span class="value">указать значение</span>
					...
					<div class="propertyDetails editPropertyRelation hide">
						...
						<div class="propertyRelation saveRelation" data-action="/admin/<?=$_REQUEST['controller']?>/ajaxEditPropertyRelation/">
							...
							<input class="editRelation saveRelationImportant" name="value" value="<?=$object->getPropertyValueById($value->id)->value?>" placeholder="Значение" type="text" />
