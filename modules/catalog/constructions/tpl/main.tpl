					...
					<form class="form<?= $object->id ? 'Edit' : 'Add'?>" action="/admin/constructions/<?= $object->id ? 'edit' : 'add'?>/" method="post" data-post-action="<?= $object->id ? 'none' : '/admin/constructions/construction/'?>">
