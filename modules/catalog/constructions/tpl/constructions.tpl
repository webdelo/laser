		...
		<div class="main single">
			<div class="max_width">
				<div class="action_buts">
					...
					<a href="/admin/parameters/?categoryId=4"><img src="/admin/images/buttons/parameters.png" height="22" alt="" /> Характеристики</a>
					<? endif; ?>
					...
					<a href="/admin/constructions/construction/"><img src="/admin/images/buttons/add.png" alt="" /> Создать</a>
					<?endif?>
					<a class="filters pointer"><img src="/admin/images/buttons/search.png" alt="" /> Фильтрация</a>
					<?if( ! $this->isAuthorisatedUserAnManager()):?>
					<a href="/admin/constructions/categories/"><img src="/admin/images/buttons/folder.png" alt="" /> Категории</a>
					<?endif?>
				</div>
				...
				<div class="table_edit">
					<table  id="objects-tbl" data-sortUrlAction="/admin/constructions/changePriority/?" width="100%">
						<tr>
						...
						<? $counter = 0; foreach ($objects as $object): ?>
							<tr id="id<?=$object->id?>" class="dblclick" data-url="/admin/constructions/construction/<?= $object->id?>" data-id="<?= $object->id?>" data-priority="<?= $object->priority?>">
								...
								<td><a href="/admin/constructions/construction/<?=$object->id?>/" class="pen"></a></td>
								<td><a class="del pointer button confirm" data-confirm="Remove the item?" data-action="/admin/constructions/remove/<?=$object->id?>/" data-callback="postRemoveArticle"></a></td>
							</tr>
						<? endforeach; ?>
					</table>
				</div>
				...
				<div class="action_edit">
					<form id="groupArray" action="/admin/constructions/groupActions/" class="groupArray" method="post" data-callback="reloadPage">
						<table>
							<tr>
							...
							<tr class="groupAction groupRemove" name="removeButton">
								<td class="first"></td>
								<td>
									<button class="remove button confirm active" data-confirm="Удалить объекты?" data-action="/admin/constructions/groupRemove/" data-data="input[name*=group]" data-callback="reloadPage">ок</button>
								</td>
							</tr>
						</table>
					</form>
