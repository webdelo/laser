				...
				<div class="action_buts">
					...
					<? if ($object->id):?>
						<a class="button confirm pointer" data-confirm= "Remove the construction?" data-action="/admin/constructions/remove/<?=$object->id?>/"
							data-callback="postRemoveFromDetails" data-post-action="/admin/constructions/constructions/" >
							<img src="/admin/images/buttons/delete.png" alt="" /> Удалить
						</a>
					<? endif;?>
					<a href="/admin/constructions/categories/"><img src="/admin/images/buttons/back.png" alt="" /> Вернуться</a>
				</div>
				<p class="speedbar"><a href="/admin/">Главная</a>     <span>></span>
					<a href="/admin/constructions/">Конструкции</a>    <span>></span>
					<a href="/admin/constructions/categories/">Категории</a>    <span>></span>
					<?= $object->id ? $object->name: 'Добавление'?>
				</p>
				<div class="clear"></div>
				<form class="form<?=($object->id)?'Edit':'AddCategory'?>" action="/admin/constructions/category<?=($object->id)?'Edit':'Add'?>/" method="post" data-post-action="/admin/constructions/categories/">
					<div id="tabs">
						<div class="tab_page">
							<ul>
