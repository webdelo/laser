				...
				<div class="table_edit">
					...
					<table  id="objects-tbl" data-sortUrlAction="/admin/modulesDomain/changeCategoriesPriority/?" width="100%">
						...
						<?foreach ($categories as $category):?>
							<tr id="id<?=$category->id?>" class="dblclick ui-selectee" data-url="/admin/modulesDomain/category/<?=$category->id?>" data-id="<?=$category->id?>" data-priority="<?=$category->priority?>">
								<td><input type="checkbox" /></td>
								<td><?=$category->id?></td>
								<td><p class="alias"><a href="/admin/modulesDomain/category/<?=$category->id?>"><?=$category->alias?></a></p></td>
								<td><p class="name"><?=$category->getName()?></p></td>
