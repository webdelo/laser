		...
		<div class="main single">
			<div class="max_width">
				<div class="action_buts">
					<a href="/admin/fabricators/fabricator/"><img src="/admin/images/buttons/add.png" alt="" /> Создать</a>
					<a class="filters pointer"><img src="/admin/images/buttons/search.png" alt="" /> Фильтрация</a>
					<a href="/admin/fabricators/categories/"><img src="/admin/images/buttons/folder.png" alt="" /> Категории</a>
				</div>
				...
				<div class="table_edit">
					...
					<table  id="objects-tbl" data-sortUrlAction="/admin/fabricators/changePriority/?" width="100%">
						<tr>
						...
						<?foreach ($objects as $object):?>
							<tr id="id<?=$object->id?>" class="dblclick" data-url="/admin/fabricators/fabricator/<?= $object->id?>" data-id="<?= $object->id?>" data-priority="<?= $object->priority?>">
								<td><input type="checkbox" class="groupElements" /></td>
								<td><?=$object->id?></td>
								<td><p class="alias"><a href="/admin/fabricators/fabricator/<?=$object->id?>/"><?=$object->alias?></a></p></td>
								<td><p class="name"><?=$object->name?></p></td>
								<td>
									<p class="category_edit"><a href="/admin/fabricators/category/<?=$object->getCategory()->id?>/"><img src="/admin/images/backgrounds/set.png" /></a></p>
								...
								<td><a href="/admin/fabricators/fabricator/<?=$object->id?>/" class="pen"></a></td>
								<td><a class="del pointer button confirm" data-confirm="Remove the item?" data-action="/admin/fabricators/remove/<?=$object->id?>/" data-callback="postRemoveArticle"></a></td>
							</tr>
						<?endforeach?>
					</table>
					<?endif?>
				...
				<div class="action_edit">
					<form id="groupArray" action="/admin/fabricators/groupActions/" class="groupArray" method="post" data-callback="reloadPage">
						<table>
							<tr>
							...
							<tr class="groupAction groupRemove" name="removeButton">
								<td class="first"></td>
								<td>
									<button class="remove button confirm active" data-confirm="Удалить объекты?" data-action="/admin/fabricators/groupRemove/" data-data="input[name*=group]" data-callback="reloadPage">ок</button>
								</td>
							</tr>
						</table>
					</form>
