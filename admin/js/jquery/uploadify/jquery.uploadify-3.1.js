	...
	var handlers = {
		...
		onSelect : function(file) {
			...
			if ($.inArray('onSelect', settings.overrideEvents) < 0) {
				...
				var element$ = '<div id="' + file.id + '" class="image">\n\
					<form class="imageSave" action="" method="post">\n\
						<table>\n\
							<tr>\n\
								<td>\n\
									<input type="text" name="title" value="' + fileName + '" />\n\
								</td>\n\
							</tr>\n\
							<tr>\n\
								<td>\n\
						...
						<div class="controls">\n\
							<a class="remove" href="javascript:$(\'#' + settings.id + '\').uploadify(\'cancel\', \'' + file.id + '\')"></a>\n\
				...
				$('#' + settings.queueID).append(element$);
