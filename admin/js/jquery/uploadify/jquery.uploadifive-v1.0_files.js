    ...
    var methods = {
        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                var $data = $this.data('uploadifiveFile');
...
//		'dropTarget'      : false,              // Selector for the drop target
			'dropTarget'      : '#placeForDrugAndDropFiles',              // Selector for the drop target
...
//		'queueID'         : false, // The ID of the file queue
                    'queueID'         : 'placeForQueueFiles',              // The ID of the file queue
                ...
                // Queue item template
                $data.queueItem = $('<div class="uploadifiveFile-queue-item">\
                ...
                if (window.File && window.FileList && window.FileReader && window.Blob) {
                    ...
                    settings.id = 'uploadifiveFile-' + $this.attr('id');

                    // Wrap the file input in a div with overflow set to hidden
                    $data.button = $('<div id="' + settings.id + '" class="uploadifiveFile-button"><span class="textButton">' + settings.buttonText + '</span></div>');
                    ...
                    if (!settings.queueID) {
                        ...
                        $data.queueEl = $('<div id="' + settings.queueID + '" class="uploadifiveFile-queue" />');
        ...
        debug : function() {
            ...
            return this.each(function() {
                ...
                console.log($(this).data('uploadifiveFile'));
	    ...
	    console.info($(this));
            this.each(function() {
                ...
                var $this    = $(this),
                    $data    = $this.data('uploadifiveFile'),
        ...
        cancel : function(file, fast) {
            ...
            this.each(function() {
                ...
                if (typeof file === 'string') {
                    if (!isNaN(file)) {
                        fileID = 'uploadifiveFile-' + $(this).attr('id') + '-file-' + file;
                    }
            ...
            this.each(function() {
                ...
                if (file) {
                    ...
                    if (($data.uploads.count + $data.uploads.current) < settings.uploadLimit || settings.uploadLimit == 0) {
                        ...
                        $('#' + settings.queueID).find('.uploadifiveFile-queue-item').not('.error, .complete').each(function() {
                        ...
                        if ($('#' + settings.queueID).find('.uploadifiveFile-queue-item').not('.error, .complete').size() == 0) {
                            $data.queueComplete();
                        }
                    } else {
    ...
    $.fn.uploadifiveFile = function(method) {
